...
const FitAndFunCoach_Form: React.FC = () => {
    return (
        <div className="fitandfunform">
            <h2 className="formheader">🏋🏼‍♀️ <span className="feature-pinkname">FIT AND FUN</span> 🏋🏼‍♀️</h2>
            ...
            <section className="homepage-features">
                ...
                <div className="feature-card" id="fitandfun">
                    <p>
                    ✨ <span className="feature-pinkname">Stéphane</span>, enseigne le fit & fun ( renforcement  musculaire) au 🏃💃STUDIO GRIS 💃🏃. 
...
Que vous vous soyez débutant ou confirmé, il saura vous embarquer dans sa passion et sa folie ! Rejoignez notre équipe ! 
                ...
                <div className="feature-card" id="stretching">
                    <p>
                    ✨ <span className="feature-pinkname">Maylis</span>, enseigne le fit and fun soft au 🏃💃STUDIO GRIS 💃🏃 ! 
